    ...
    items: [
      {
        ...
        price: '$12.50',
        image: 'https://images.unsplash.com/photo-1603046891744-76e6300f82ef?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80'
      },
      {
        id: 'breakfast-bowl',
        name: 'Paradise Breakfast Bowl',
        description: 'Quinoa, roasted vegetables, poached egg, and house dressing',
        price: '$14.75',
      ...
      },
      {
        ...
        description: 'Thick-cut brioche with maple syrup, berries, and whipped mascarpone',
        price: '$13.50',
      ...
      },
      {
        ...
        description: 'House-made English muffin with egg, aged cheddar, and bacon',
        price: '$11.25',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Grass-fed beef, aged cheddar, caramelized onions, and special sauce',
        price: '$16.50',
    ...
    items: [
      {
        ...
        description: 'Locally sourced ribeye with herb butter and roasted vegetables',
        price: '$32.00',
        image: 'https://images.unsplash.com/photo-1546964124-0cce460f38ef?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80'
      },
      {
        id: 'salmon',
        name: 'Cedar Plank Salmon',
        description: 'Wild-caught salmon with lemon herb sauce and seasonal sides',
        price: '$28.75',
      ...
      },
      {
        id: 'pasta',
        name: 'Handmade Pasta',
        description: 'Fresh pasta with seasonal vegetables and house-made sauce',
        price: '$24.50',
    ...
    <section id="menu" className="py-20 px-4 bg-dark-espresso relative grain">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          <h2 className="font-serif text-4xl md:text-5xl font-bold mb-4 text-almond-cream">Our Menu</h2>
                ...
                {category.items.map((item) => (
                  ...
                  >
                    ...
                    <div className="p-5 md:w-2/3 flex flex-col justify-between">
                      <div>
                        <h3 className="font-menu text-xl font-semibold mb-2 text-almond-cream">{item.name}</h3>
                        <p className="text-sm text-almond-cream/70 mb-4">{item.description}</p>
                      </div>

...
const galleryImages = [
  ...
  {
    id: 4,
    src: 'https://images.unsplash.com/photo-1525480122447-64809d765a77?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80',
...
export function GallerySection() {
  ...
  return (
    <section id="gallery" className="py-20 px-4 bg-charcoal-roast relative grain">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          <h2 className="font-serif text-4xl md:text-5xl font-bold mb-4 text-almond-cream">Gallery</h2>
